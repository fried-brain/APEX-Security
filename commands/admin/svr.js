...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    if(!serverRegion) return message.channel.send("Please provide a region! OR use ahelp svr to know region ID");
    ...
    if(availableRegions.includes(serverRegion)) {
      ...
      return message.channel.send("Please provide a valid region ID! Please use \`ahelp region\` to view all available region IDs!")
    }
